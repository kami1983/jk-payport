...
<p>
<?php echo htmlspecialchars(Yii::app()->request->baseUrl.$this->createUrl('paypal/payment',array()).'&uid='.$index.'&masksign='.md5($index.$conf_arr['token']).'&price_arr[0]=5&client_secret=YOUR_ARE_PAYPAL_SECRET'); ?>    
</p>
<?php endforeach; ?>
<p>
